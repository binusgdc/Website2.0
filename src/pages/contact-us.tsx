                    ...
                    <div className=" lg:w-auto ">
                        <div className="place-content-center">
                            <div className="flex sm:ml-0 ml-8">
                                <a>
                                    <Image src="/phone.png" alt="" width={28} height={28} />
                                </a>
                            ...
                            <div className="flex mt-14 sm:ml-0 ml-8">
                                <Image src="/maps.png" alt="" width={28} height={28} />
                                <h1 className="lg:text-lg text-md font-bold text-neutral-700 ml-3">
                                    Address
                                </h1>
                            </div>
                        ...
                        <div className="flex mt-14 ml-10 flex-col lg:mb-0 mb-20">
                            ...
                            <div className="flex mt-3 gap-1 lg:space-x-4 space-x-2">
                                <a
                                ...
                                <a href="https://bgdc.itch.io/" className="text-gray-900 ">
                                    <svg
                                        className="w-5 h-5 "
                                        fill="currentColor"
                                        viewBox="0 0 512 512"
                                ...
                                <a href="https://twitter.com/Binusgdc" className="text-gray-900">
                                    <svg
                                        className="w-5 h-5 "
                                        fill="currentColor"
                                        viewBox="0 0 24 24"
