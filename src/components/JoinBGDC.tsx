                        ...
                        <div className="flex flex-wrap flex-col-reverse sm:flex-row-reverse">
                            <div className="w-full sm:w-1/2 p-6 mt-6">
                                <div className="align-middle">
                                    ...
                                    <p className="text-gray-600 mb-8">
                                        Server discord memiliki berbagai macam sub komunitas yang
                        ...
                        <div className="flex flex-wrap flex-col sm:flex-row-reverse">
                            ...
                            <div className="w-full sm:w-1/2 p-6 mt-6 ">
                                <div className="align-middle">
                                    ...
                                    <p className="text-gray-600 mb-8">
                                        Untuk member yang juga ingin belajar game development, BGDC
                                        juga menyediakan berbagai kelas game development. Kelas ini
                                        mencakupi banyak hal mulai dari programming, design, art,
                                        sampai sound.
                                    </p>
                                    <div className="flex space-x-2 justify-center md:justify-start">
                                        <div>
                        ...
                        <div className="flex flex-wrap flex-col-reverse sm:flex-row-reverse">
                            <div className="w-full sm:w-1/2 p-6 mt-6 ">
                                <div className="align-middle">
                                    ...
                                    <p className="text-gray-600 mb-8">
                                        Member BGDC bisa apply menjadi aktivis dimana mereka bisa
                                        belajar cara mengurus sebuah organisasi. Aktivis akan
                                        mendapatkan banyak pengalaman terutama terkait soft skills
                                        dan hard skills.
                                    </p>
                                    <div className="flex space-x-2 justify-center md:justify-start">
                                        <div>
