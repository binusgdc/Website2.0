    ...
    return (
        <>
            <div className=" pt-4 pb:4 md:pb-8">
                ...
                <div className="flex justify-center mt-16 lg:items-center items-auto">
                    <div className=" lg:w-auto w-1/3">
                        <div className="place-content-center">
                            <div className="flex ">
                                ...
                                <h1 className="lg:text-lg text-md font-bold text-neutral-700 ml-4">
                                    Telephone Number
                                </h1>
                            </div>

                            <h1 className="ml-10 md:ml-12 font-semibold  mt-4 text-sm ">
                                021 – 2977 9100
                            </h1>
                            ...
                            <h1 className="ml-8 md:ml-10 font-semibold mt-4 text-sm  w-4/5">
                    ...
                    <div>
                        <a>
                            <img
                                src="/images/syahdan.png"
                                className="ml-8 lg:w-96 lg:h-96 w-48 h-48 max-w-min object-scale-down"
                                alt=""
                            />
                        </a>
                    </div>
